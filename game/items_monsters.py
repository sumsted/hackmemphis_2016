...
ITEMS = [
    ...
    {'name': 'jay hawk', 'attack': 10, 'health': 4},
    {'name': 'bandit', 'attack': 1, 'health': 1},
    {'name': 'rebel', 'attack': 30, 'health': 3},
    {'name': 'owl', 'attack': 15, 'health': 10},
    {'name': 'green wave', 'attack': 15, 'health': 2},
    {'name': 'mid ship man', 'attack': 20, 'health': 1},
    {'name': 'captain cane', 'attack': 10, 'health': 2},
    {'name': 'mustang', 'attack': 10, 'health': 5},
    {'name': 'rocky the bull', 'attack': 20, 'health': 10},
    {'name': 'bear cat', 'attack': 20, 'health': 2},
